...
<body>
<div  id="table" class="bgcolor">
		<h2 id="table_title" style="color:white;text-align:center; padding:20px 0px 40px 0px; font-weight:800;">Flight Database Table</h2>
		<table class="table whitebig">
  			<thead>
    			<tr>
